...
G4ThreadLocal G4Allocator<Trayectoria>* TrayectoriaAllocator = nullptr;
...
Trayectoria::Trayectoria(const G4Track* aTrack)
...
Trayectoria::Trayectoria(Trayectoria &right)
...
void Trayectoria::DrawTrajectory() const
{
