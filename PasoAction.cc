...
PasoAction::PasoAction(EventoAction* ea)
  : fOneStepPrimaries(false),
    fEventAction(ea)
{
  fSteppingMessenger = new PasoMessenger(this);
...
PasoAction::~PasoAction() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void PasoAction::UserSteppingAction(const G4Step * theStep){

  G4Track* theTrack = theStep->GetTrack();

  if ( theTrack->GetCurrentStepNumber() == 1 ) fExpectedNextStatus = Undefined;
 
  UsuarioTrackInformation* trackInformation
    =(UsuarioTrackInformation*)theTrack->GetUserInformation();
  ...
  if(theTrack->GetParentID()==0){
    ...
    if(fOneStepPrimaries&&thePrePV->GetName()=="Agua_physical")
