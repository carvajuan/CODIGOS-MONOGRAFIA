...
#ifndef EventoAction_h
#define EventoAction_h 1
...
class EventoAction : public G4UserEventAction
{
  public:

    EventoAction(const ConstruccionDetector*);
    virtual ~EventoAction();
  ...
  private:
	...
	FILE* archivo;
    EventoMessenger* fEventMessenger;
