...
void Correr::Merge(const G4Run* run)
{
  const Correr* localRun = static_cast<const Correr*>(run);
...
void Correr::EndOfRun()
{
  ...
  G4cout << "El numero total de eventos fueron: " << n_evt << " En total" << G4endl;
